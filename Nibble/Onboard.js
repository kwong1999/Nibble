    ...
    return(
      <View style = {{flex:10, backgroundColor: '#8134FF', alignItems: 'center'}}>
        ...
        <View style = {{flex: 9, top:400}}>
          ...
          <TouchableOpacity onPress = {()=>this.props.navigation.navigate('Home')} style = {[{marginTop: 40, alignItems: 'center',}]}><Text style = {{color:'#FFFFFF', fontSize: 14, fontWeight: 'bold'}}>Skip for now</Text></TouchableOpacity>
        </View>
      </View>
      );
  }
